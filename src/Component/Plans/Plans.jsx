...
export default function Plans() {
  return (
    <>
      <div
        className=" container flex flex-col justify-center overflow-hidden mx-auto py-10 mt-5"
        id="Plans"
      >
        <div className=" flex flex-col text-2xl gap-y-1 text-center md:text-2xl lg:text-5xl font-bold uppercase md:flex-row justify-around items-center">
          ...
          <i className="stroke-text">now withus</i>
        </div>
        <div className="flex flex-wrap gap-y-10  items-center justify-center mt-20">
          ...
          >
            <div className=" flex flex-col bg-[#656565] p-[1.5rem] rounded-tl-4xl rounded-br-4xl">
              ...
              <button className=" hover:cursor-pointer bg-white text-black py-2 font-bold button-style">
                Join now
              </button>
            </div>
          </motion.div>

          <div className="lg:px-6 w-12/12 lg:w-4/12">
            <div className=" flex flex-col card-style lg:scale-110 p-[1.5rem] rounded-tl-4xl rounded-br-4xl">
              ...
              <button className="hover:cursor-pointer bg-white text-orange-400 py-2 font-bold button-style">
                Join now
              </button>
            </div>
          </div>
