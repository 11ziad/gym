...
export default function Programs() {
  ...
  <motion.section
   variants={fadeIn('up',.2)}
             initial='hidden'
             whileInView={"show"}
  className=' container pb-10 mx-auto ' id='programe'>
    ...
    <div className=" flex flex-wrap  justify-center items-center  gap-y-4 lg:flex-row mt-6">
      <div className="md:px-2  w-12/12 md:w-6/12 lg:w-3/12">
        ...
        <i className="fa-solid fa-dumbbell text-[30px] mb-6 "></i>
            ...
            <p className=' mb-4 text-sm'>In this program, you are trained to improve your strength through many exercises.</p>
            <button>Join Now <span className=' ms-6'><i className="fa-solid fa-arrow-right"></i></span>
            </button>
        </div>
      </div>
      <div className="md:px-2  w-12/12 md:w-6/12  lg:w-3/12">
        ...
        <i className="fa-solid fa-person-running text-[30px] mb-6"></i>
            ...
            In this program, you are trained to do sequential moves in range of 20 until 30 minutes.            </p>
            <button>Join Now <span className=' ms-6'><i className="fa-solid fa-arrow-right"></i></span>
            </button>
        </div>
      </div>
      <div className="md:px-2  w-12/12 md:w-6/12  lg:w-3/12">
        ...
        <i className="fa-solid fa-fire-flame-curved  text-[30px] mb-6"></i>
            ...
            <p className=' mb-4 text-sm'>
            This program is suitable for you who wants to get rid of your fat and lose their weight.            </p>
            <button>Join Now <span className=' ms-6'><i className="fa-solid fa-arrow-right"></i></span>
            </button>
        </div>
      </div>
